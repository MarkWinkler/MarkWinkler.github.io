...
// Google Maps API section, Reference [8]
  ...
  function initMap(){
    var myLocation = {lat: 52.2852, lng: -1.5201};
...
// CODE Employment Details - repeat from LASA example
(function(){
  let popup = document.getElementById("popup-id-current");          // Linking it to the next id.
  let openPopup = document.getElementById("employer-current");      // Linking it to the next employer.
  let span = document.getElementsByClassName("close-current")[0];   // Linking to the next close.
